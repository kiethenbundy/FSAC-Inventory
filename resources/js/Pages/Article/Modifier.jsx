...
export default function Create({ auth, task, projects, users }) {
  const { data, setData, post, errors, reset } = useForm({
    ...
    assigned_fournisseur_id: task.assigned_fournisseur_id || "",
    _method: "PUT",
  });
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            ...
            >
              ...
              <div>
                <InputLabel htmlFor="task_project_id" value="MouvementStock" />
                ...
                >
                  ...
                  {projects.data.map((mouvementstock) => (
              ...
              <div className="mt-4">
                ...
                <SelectInput
                  ...
                  value={data.assigned_fournisseur_id}
                  className="mt-1 block w-full"
