...
export default function Create({ auth, mouvementstock }) {
  const { data, setData, post, errors, reset } = useForm({
    image: "",
    name: mouvementstock.name || "",
    status: mouvementstock.status || "",
    description: mouvementstock.description || "",
    due_date: mouvementstock.due_date || "",
    _method: "PUT",
  });
  ...
  const onSubmit = (e) => {
    ...
    post(route("mouvementstock.update", mouvementstock.id));
  };
      ...
      header={
        <div className="flex justify-between items-center">
          <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Edit mouvementstock "{mouvementstock.name}"
          </h2>
        </div>
      }
    >
      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            ...
            >
              {mouvementstock.image_path && (
                <div className="mb-4">
                  <img src={mouvementstock.image_path} className="w-64" />
                </div>
              )}
              <div>
                <InputLabel
